...
<head>
	...
	<title>Uniledge | Личный кабинет(редактирование)</title>
...
<body>
	...
	<section class="profile" id="profile">
		...
		<div class="profile_container">
			<div class="profile_information">
				...
				<label for="edit_last_name" style="margin-top: 5vh">Фамилия</label>
				<input type="text" name="edit_last_name" class="profile_input" id="edit_last_name" maxlength="30">

				<label for="edit_last_name">Имя</label>
				<input type="text" name="edit_first_name" class="profile_input" id="edit_first_name" maxlength="30">
			...
			<div class="profile_information">
				...
				<form action="change-password.php" method="post">
					...
					<input type="password" name="old_password" class="profile_input" pattern='^[A-Za-zА0-9@"\s]+$' minlength="5"  maxlength="16"  id="old_password" required>

					<label for="new_password" id="old_label">Новый пароль</label>
					<input type="password" name="new_password" class="profile_input" pattern='^[A-Za-zА0-9@"\s]+$' minlength="5"  maxlength="16"  id="new_password" required>
					...
					<button type="submit" class="btn" id="change_btn_pas">Сменить пароль</button>
				</form>
			</div>
		</div>
	</section>
	...
	<script>
		...
		$(document).ready(function() {
			$("#edit_date_of_birth").mask("99/99/9999");
		});
